...
function shifters_lite_setup() { 		
	$GLOBALS['content_width'] = apply_filters( 'shifters_lite_content_width', 680 );	
 ...
 */
add_action( 'after_setup_theme', 'shifters_lite_setup_woocommerce_support' );
function shifters_lite_setup_woocommerce_support()   
{
 ...
 */
function shifters_lite_skip_link_focus_fix() {  
...
add_action( 'wp_print_footer_scripts', 'shifters_lite_skip_link_focus_fix' );